  ...
  const openModal = (transaction = null) => {
    if (transaction) {
      ...
      setFormData({
        ...
        toWalletId: transaction.toWalletId || 0,
              ...
              <div className="flex bg-slate-100 p-1 rounded-xl gap-1">
                {[
                  ...
                  <button
                    ...
                    className={`flex-1 flex items-center justify-center gap-2 py-2 rounded-lg text-sm font-medium transition-all ${formData.type === type.id ? 'bg-white text-primary shadow-sm' : 'text-slate-500 hover:text-slate-700'
                      }`}
                  >
                ...
                {formData.type !== 3 && (
                  <div>
                    ...
                    >
                      ...
                      {categories
                        .filter(c => c.type === formData.type) // 🔥 đúng với enum backend
                        .map(c => (
